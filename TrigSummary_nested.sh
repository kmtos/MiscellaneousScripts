...
for dir in FakeRate/*; do
  echo "dir=$dir"
  for file in $dir/*stdout*; do
    echo "dir/file=$file"
...
echo "Visited= $sumTriggerSelectorVisited    Passed= $sumTriggerSelectorPassed    Failed= $sumTriggerSelectorFailed : TriggerSelector"
