...
void rootMacro_DYFakeRate()
{
  ...
  TFile infile ("/home/kyletos/Downloads/RootFiles/ABCD_Tests/FakeRateDY/FINAL_AllEra_DY_FakeRate_Inv81to101_Mu51_MedMuID_MultiTrig_JUL3_FineBin.root");
  TFile *outFile = new TFile("/home/kyletos/Downloads/RootFiles/ABCD_Tests/FakeRateDY/COMBINED_DY_FakeRate_Inv81to101_Mu51_MedMuID_MultiTrig_JUL3_FineBin.root", "RECREATE");
...
std::cout << "Declaring TGraph" << std::endl;
  ...
  TCanvas FinalFakeRateLooseIsoEtavsPtWithSoftMuon_noMu("FinalFakeRateLooseIsoEtavsPtWithSoftMuon_noMuCanvas","",600,600);
  TCanvas FinalFakeRateMedIsoEtavsPtWithSoftMuon_noMu("FinalFakeRateMedIsoEtavsPtWithSoftMuon_noMuCanvas","",600,600);
  TCanvas FinalFakeRateTightIsoEtavsPtWithSoftMuon_noMu("FinalFakeRateTightIsoEtavsPtWithSoftMuon_noMuCanvas","",600,600);
  TCanvas FinalFakeRateDMFindEtavsPtWithSoftMuon_noMu("FinalFakeRateDMFindEtavsPtWithSoftMuon_noMuCanvas","",600,600);
  ...
  TCanvas FinalFakeRateLooseIsoEtavsPtWithSoftMuon("FinalFakeRateLooseIsoEtavsPtWithSoftMuonCanvas","",600,600);
  TCanvas FinalFakeRateMedIsoEtavsPtWithSoftMuon("FinalFakeRateMedIsoEtavsPtWithSoftMuonCanvas","",600,600);
  TCanvas FinalFakeRateTightIsoEtavsPtWithSoftMuon("FinalFakeRateTightIsoEtavsPtWithSoftMuonCanvas","",600,600);
  TCanvas FinalFakeRateDMFindEtavsPtWithSoftMuon("FinalFakeRateDMFindEtavsPtWithSoftMuonCanvas","",600,600);
  ...
  TCanvas FinalFakeRateLooseIsoEtavsPt("FinalFakeRateLooseIsoEtavsPtCanvas","",600,600);
  TCanvas FinalFakeRateMedIsoEtavsPt("FinalFakeRateMedIsoEtavsPtCanvas","",600,600);
  TCanvas FinalFakeRateTightIsoEtavsPt("FinalFakeRateTightIsoEtavsPtCanvas","",600,600);
  TCanvas FinalFakeRateDMFindEtavsPt("FinalFakeRateDMFindEtavsPtCanvas","",600,600);
  TCanvas FinalFakeRateDMtoMedIsoOnlyEtavsPt("FinalFakeRateDMtoMedIsoOnlyEtavsPtCanvas","",600,600);
...
cout << "Attributes set." << endl;  
  ...
  TCanvas COMB_FakeRatePtDMFind_("COMB_FakeRatePtDMFind","",600,600);
  TCanvas COMB_FakeRatePtMedIso_("COMB_FakeRatePtMedIso","",600,600);
  TCanvas COMB_FakeRatePtLooseIso_("COMB_FakeRatePtLooseIso","",600,600);
  TCanvas COMB_FakeRatePtTightIso_("COMB_FakeRatePtTightIso","",600,600);
  ...
  TCanvas COMB_FakeRateEtaDMFind_("COMB_FakeRateEtaDMFind","",600,600);
  TCanvas COMB_FakeRateEtaMedIso_("COMB_FakeRateEtaMedIso","",600,600);
  TCanvas COMB_FakeRateEtaLooseIso_("COMB_FakeRateEtaLooseIso","",600,600);
  TCanvas COMB_FakeRateEtaTightIso_("COMB_FakeRateEtaTightIso","",600,600);
  ...
  TCanvas COMB_FakeRateEtavsPtDMFind_("COMB_FakeRateEtavsPtDMFind","",600,600);
  TCanvas COMB_FakeRateEtavsPtMedIso_("COMB_FakeRateEtavsPtMedIso","",600,600);
  TCanvas COMB_FakeRateEtavsPtLooseIso_("COMB_FakeRateEtavsPtLooseIso","",600,600);
  TCanvas COMB_FakeRateEtavsPtTightIso_("COMB_FakeRateEtavsPtTightIso","",600,600);
  ...
  TCanvas COMBAllIso_FakeRatePt_("COMBAllIso_FakeRatePt","",600,600);
  TCanvas COMBAllIso_FakeRatePtWithSoftMuon_noMu_("COMBAllIso_FakeRatePtWithSoftMuon_noMu","",600,600);
  TCanvas COMBAllIso_FakeRatePtWithSoftMuon_("COMBAllIso_FakeRatePtWithSoftMuon","",600,600);
  ...
  TCanvas COMBAllIso_FakeRateEta_("COMBAllIso_FakeRateEta","",600,600);
  TCanvas COMBAllIso_FakeRateEtaWithSoftMuon_noMu_("COMBAllIso_FakeRateEtaWithSoftMuon_noMu","",600,600);
  TCanvas COMBAllIso_FakeRateEtaWithSoftMuon_("COMBAllIso_FakeRateEtaWithSoftMuon","",600,600);
  ...
  TCanvas COMBAllIso_FakeRateEtavsPt_("COMBAllIso_FakeRateEtavsPt","",600,600);
  TCanvas COMBAllIso_FakeRateEtavsPtWithSoftMuon_noMu_("COMBAllIso_FakeRateEtavsPtWithSoftMuon_noMu","",600,600);
  TCanvas COMBAllIso_FakeRateEtavsPtWithSoftMuon_("COMBAllIso_FakeRateEtavsPtWithSoftMuon","",600,600);
  ...
  FinalFakeRateDMtoMedIsoOnlyEtavsPt_->Draw("COLZ");
