...
process.ggh = cms.EDAnalyzer("SkimCheck",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_8_0_17/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/BSUB/QCD_80to120_Massgt25_FEB9/QCD_80to120_Massgt25_FEB9_44.root'),
