...
void CombineData() { 
  ...
  Target = new TFile("/home/kyletos/Downloads/RootFiles/ABCD_Tests/FakeRateEstimate/FINAL_SingleMu_AntiMedIsoMu2_TauDMAntiMedIso_MAY1_CFromD.root", "RECREATE" );
  FileList = new TList();
  FileList->Add( TFile::Open("/home/kyletos/Downloads/RootFiles/ABCD_Tests/FakeRateEstimate/FINAL_SingleMu1_AntiMedIsoMu2_TauDMAntiMedIso_MAY1_CFromD.root") );
  FileList->Add( TFile::Open("/home/kyletos/Downloads/RootFiles/ABCD_Tests/FakeRateEstimate/FINAL_SingleMu2_AntiMedIsoMu2_TauDMAntiMedIso_MAY1_CFromD.root") );
