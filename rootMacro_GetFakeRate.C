...
cout << "Files Created" << endl;
  ...
  TH2F* EtavsPtTauLooseIso_ = (TH2F*)infile.Get("EtavsPtTauLooseIso");
  TH2F* EtavsPtTauMedIso_ = (TH2F*)infile.Get("EtavsPtTauMedIso");
  TH2F* EtavsPtTauTightIso_ = (TH2F*)infile.Get("EtavsPtTauTightIso");
  TH2F* EtavsPtTauDMFind_ = (TH2F*)infile.Get("EtavsPtTauDMFind");
  TH2F* EtavsPtJet_ = (TH2F*)infile.Get("EtavsPtJet");
  TH2F* EtavsPtJetSoftMuon_ = (TH2F*)infile.Get("EtavsPtJetSoftMuon");
  TH2F* EtavsPtJetSoftMuon_noMu_ = (TH2F*)infile.Get("EtavsPtJetSoftMuon_noMu");

  TH1F* TauLooseIsoEta_ = (TH1F*)infile.Get("TauLooseIsoEta");
  TH1F* TauMedIsoEta_ = (TH1F*)infile.Get("TauMedIsoEta");
  TH1F* TauTightIsoEta_ = (TH1F*)infile.Get("TauTightIsoEta");
  TH1F* TauDMFindEta_ = (TH1F*)infile.Get("TauDMFindEta");
  TH1F* JetEta_ = (TH1F*)infile.Get("JetEta");
  TH1F* JetEtaWithSoftMuon_ = (TH1F*)infile.Get("JetEtaWithSoftMuon");
  TH1F* JetEtaWithSoftMuon_noMu_ = (TH1F*)infile.Get("JetEtaWithSoftMuon_noMu");

  TH1F* TauLooseIsoPt_ = (TH1F*)infile.Get("TauLooseIsoPt");
  TH1F* TauMedIsoPt_ = (TH1F*)infile.Get("TauMedIsoPt");
  TH1F* TauTightIsoPt_ = (TH1F*)infile.Get("TauTightIsoPt");
  TH1F* TauDMFindPt_ = (TH1F*)infile.Get("TauDMFindPt");
  TH1F* JetPt_ = (TH1F*)infile.Get("JetPt");
  TH1F* JetPtWithSoftMuon_ = (TH1F*)infile.Get("JetPtWithSoftMuon");
  TH1F* JetPtWithSoftMuon_noMu_ = (TH1F*)infile.Get("JetPtWithSoftMuon_noMu");

  TH1F* OneProngDMEta_ = (TH1F*)infile.Get("OneProngDMEta");
  TH1F* OneProngOnePizDMEta_ = (TH1F*)infile.Get("OneProngOnePizDMEta");
  TH1F* OneProngTwoPizDMEta_ = (TH1F*)infile.Get("OneProngTwoPizDMEta");
  TH1F* ThreeProngDMEta_ = (TH1F*)infile.Get("ThreeProngDMEta");
  TH1F* OneProngDMPt_ = (TH1F*)infile.Get("OneProngDMPt");
  TH1F* OneProngOnePizDMPt_ = (TH1F*)infile.Get("OneProngOnePizDMPt");
  TH1F* OneProngTwoPizDMPt_ = (TH1F*)infile.Get("OneProngTwoPizDMPt");
  TH1F* ThreeProngDMPt_ = (TH1F*)infile.Get("ThreeProngDMPt");

  TH1F* OneProngMedIsoEta_ = (TH1F*)infile.Get("OneProngMedIsoEta");
  TH1F* OneProngOnePizMedIsoEta_ = (TH1F*)infile.Get("OneProngOnePizMedIsoEta");
  TH1F* OneProngTwoPizMedIsoEta_ = (TH1F*)infile.Get("OneProngTwoPizMedIsoEta");
  TH1F* ThreeProngMedIsoEta_ = (TH1F*)infile.Get("ThreeProngMedIsoEta");
  TH1F* OneProngMedIsoPt_ = (TH1F*)infile.Get("OneProngMedIsoPt");
  TH1F* OneProngOnePizMedIsoPt_ = (TH1F*)infile.Get("OneProngOnePizMedIsoPt");
  TH1F* OneProngTwoPizMedIsoPt_ = (TH1F*)infile.Get("OneProngTwoPizMedIsoPt");
  TH1F* ThreeProngMedIsoPt_ = (TH1F*)infile.Get("ThreeProngMedIsoPt");
...
std::cout << "Formatting" << std::endl;
  ...
  FinalFakeRateLooseIsoPt_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateMedIsoPt_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateTightIsoPt_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateDMFindPt_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
//  FinalFakeRateDMtoMedIsoPt_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  ...
  FinalFakeRateLooseIsoPtWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateMedIsoPtWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateTightIsoPtWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateDMFindPtWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  ...
  FinalFakeRateLooseIsoPtWithSoftMuon_noMu_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateMedIsoPtWithSoftMuon_noMu_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateTightIsoPtWithSoftMuon_noMu_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateDMFindPtWithSoftMuon_noMu_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  ...
  FinalFakeRateLooseIsoEta_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateMedIsoEta_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateTightIsoEta_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateDMFindEta_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  ...
  FinalFakeRateLooseIsoEtaWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateMedIsoEtaWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateTightIsoEtaWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
  FinalFakeRateDMFindEtaWithSoftMuon_->SetTitle("Fake Rate: RegionA, 0.5 < dR(#tau_{H},#mu_{3}) < 0.8, 81 < M(#mu_{1}#mu_{2}) < 101");
...
//  ThreeProngMedIsoPtCanvas->Write();
  ...
  FinalFakeRateLooseIsoEtavsPt_->Draw("COLZTEXT60 E");
  gPad->Update();
  ...
  FinalFakeRateMedIsoEtavsPt_->Draw("COLZTEXT60 E");
  gPad->Update();
  ...
  FinalFakeRateTightIsoEtavsPt_->Draw("COLZTEXT60 E");
  gPad->Update();
  ...
  FinalFakeRateDMFindEtavsPt_->Draw("COLZTEXT60 E");
  gPad->Update();
  ...
  FinalFakeRateLooseIsoEtavsPtWithSoftMuon_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateMedIsoEtavsPtWithSoftMuon_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateTightIsoEtavsPtWithSoftMuon_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateDMFindEtavsPtWithSoftMuon_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateLooseIsoEtavsPtWithSoftMuon_noMu_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateMedIsoEtavsPtWithSoftMuon_noMu_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateTightIsoEtavsPtWithSoftMuon_noMu_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateDMFindEtavsPtWithSoftMuon_noMu_->Draw("COLZTEXT60 E");
  ...
  FinalFakeRateDMtoMedIsoOnlyEtavsPt_->Draw("COLZTEXT60 E");
  gPad->Update();
  ...
  FinalFakeRateDMtoMedIsoOnlyPt->SaveAs("/home/kyletos/Desktop/NewPlots/TauFakeRateDMtoMedIsoPt.png");
  FinalFakeRateDMtoMedIsoOnlyPt->SetLogy(true);
  FinalFakeRateDMtoMedIsoOnlyPt->SaveAs("/home/kyletos/Desktop/NewPlots/TauFakeRateDMtoMedIsoPtLog.png");
