...
void rootMacro_Massgt25()
{
  ...
  //Old DMs
  TFile infileTT("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_TTBar_Massgt25_FEB9.root");
  TFile infileQCD1000toInf("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_1000toInf_Massgt25_FEB9.root");
  TFile infileQCD800to1000("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_800to1000_Massgt25_FEB9.root");
  TFile infileQCD600to800("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_600to800_Massgt25_FEB9.root");
  TFile infileQCD470to600("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_470to600_Massgt25_FEB9.root");
  TFile infileQCD300to470("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_300to470_Massgt25_FEB9.root");
  TFile infileQCD170to300("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_170to300_Massgt25_FEB9.root");
  TFile infileQCD120to170("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_120to170_Massgt25_FEB9.root");
  TFile infileQCD80to120("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_80to120_Massgt25_FEB9.root");
  TFile infileQCD50to80("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_50to80_Massgt25_FEB9.root");
  TFile infileQCD30to50("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_30to50_Massgt25_FEB9.root");
  TFile infileQCD20to30("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_20to30_Massgt25_FEB9.root");
  TFile infileQCD15to20("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_QCD_15to20_Massgt25_FEB9.root");
  TFile infileDYH("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_DYHighMass_Massgt25_FEB9.root");
  TFile infileDYL("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_DYLowMass_Massgt25_FEB9.root");

  TFile infileH125a19("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_SignalH125a19_Massgt25_FEB9.root");
  TFile infileH125a9("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_SignalH125a9_Massgt25_FEB9.root");
  TFile infileH125a5("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_SignalH125a5_Massgt25_FEB9.root");
  TFile infileH750a9("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/FINAL_SignalH750a9_Massgt25_FEB9.root");

  TFile *outFile = new TFile("/home/kyletos/Downloads/RootFiles/CombinedPlots/comb_Massgt25_FEB9.root", "RECREATE");

  ofstream infoFile;
  infoFile.open ("/home/kyletos/Downloads/RootFiles/ABCD_Tests/Massgt25/Massgt25_FEB9.txt");
...
cout << "Files Created" << endl;
  ...
  TCanvas *IsoRawCanvasH125a5 = (TCanvas*)infileH125a5.Get("IsoRaw");
...
cout << "Histograms assigned." << endl; 
  ...
  double scale_QCD1000toInf = 10.4305 * 20000.0 / 3884666.0 ;
  double scale_QCD800to1000 = 32.3486 * 20000.0 / 3953740.0 ;
  double scale_QCD600to800 = 187.109 * 20000.0 / 3874566.0 ;
  double scale_QCD470to600  = 645.528 * 20000.0 / 3606911.0 ;
  double scale_QCD300to470  = 7820.25 * 20000.0 / 7486452.0 ;
  double scale_QCD170to300  = 117989.0 * 20000.0 / 7806467.0 ;
  double scale_QCD120to170  = 469797.0 * 20000.0 / 7925929.0 ;
  double scale_QCD80to120   = 2758420.0 * 20000.0 / 13870432.0;
  double scale_QCD50to80    = 19222500.0 * 20000.0 / 20383957.0 ;
  double scale_QCD30to50    = 139803000.0 * 20000.0 / 27765359.0 ; 
  double scale_QCD20to30    = 558528000.0 * 20000.0 / 31565787.0 ; 
  double scale_QCD15to20    = 1273190000.0 * 20000.0 / 4617630.0 ;
...
/////////////////////////////
  ...
  TH1F*  TauMuTauHaddRQCD_ = new TH1F("TauMuTauHaddR","", 25, 0, 8);
  TH1F*  MassDiLepRECOQCD_ = new TH1F("MassDiLepRECO","", 25, 70, 120);
  TH1F*  NConstituentsQCD_ = new TH1F("NConstituents","", 25, 0, 50); 
  TH1F*  PtOverMassMu1Mu2QCD_ = new TH1F("PtOverMassMu1Mu2","", 25, 0, 50);
  TH1F*  PtTauMuQCD_  = new TH1F("PtTauMu","", 100, 0, 100);
  TH1F*  PtMu1Mu2QCD_  = new TH1F("PtMu1Mu2","", 25, 0, 300);
  TH1F*  PCSVBDiscQCD_ = new TH1F("PCSVBDisc","", 25, 0, 1);
  TH1F*  SumHTQCD_     = new TH1F("SumHT","", 50, 0, 500);
  TH1F*  IsoRawQCD_    = new TH1F("IsoRaw","", 50, 0, 1000);

  TH1F*  NEventsCutsQCD_ = new TH1F("NEventsCuts","", 13, -.5, 12.5); 
...
////////////////////////////////////////////////////////
  ...
  MassDiLepRECOH125a9_->SetLineColor(kRed);
  NConstituentsH125a9_->SetLineColor(kRed);
