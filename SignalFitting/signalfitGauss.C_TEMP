...
void signalfitGauss()
{
 ...
 TFile *outFile = new TFile("/home/kyletos/Downloads/RootFiles/ABCD_Tests/ShapeDifferences/Gaussian_Reduced/Fit_OUTPUTNAME", "RECREATE");
...
///////////////////////////////
  ...
  outFile->cd();
  pt->Draw();
  c->SaveAs("/home/kyletos/Downloads/RootFiles/ABCD_Tests/ShapeDifferences/Gaussian_Reduced/IMAGENAME.png");
  c->Write();
  outFile->Close();
  w1.Print();
