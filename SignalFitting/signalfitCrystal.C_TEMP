...
void signalfitCrystal()
{

  RooWorkspace w1("w1");

 TFile *filesignal = TFile::Open("FILENAME");
 TFile *outFile = new TFile("/home/kyletos/Downloads/RootFiles/ABCD_Tests/ShapeDifferences/CrystalBall_Reduced/Fit_OUTPUTNAME", "RECREATE");
...
///////////////////////////////
  ...
  outFile->cd();
  pt->Draw();
  c->SaveAs("/home/kyletos/Downloads/RootFiles/ABCD_Tests/ShapeDifferences/CrystalBall_Reduced/IMAGENAME.png");
  c->Write();
  outFile->Close();
  w1.Print();
